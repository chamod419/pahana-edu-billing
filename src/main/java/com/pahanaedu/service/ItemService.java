...
public class ItemService {
    ...
    public List<Item> active() { return dao.findActive(); }
    ...
    public List<Item> searchBillable(String term, int limit){ return dao.searchBillable(term, limit); }
    ...
    public enum DeleteResult { OK, IN_USE, ERROR }
