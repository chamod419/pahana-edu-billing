...
public class BillingPdfController extends HttpServlet {
    ...
    private Bill requireBill(HttpServletRequest req) throws IOException {
        ...
        try {
            ...
            return b;
        } catch (SQLException e) { throw new IOException("Database error while loading bill", e); }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if ("/billing/receipt.pdf".equals(path)) {
            ...
            String filename = "receipt-" + (bill.getBillNo()!=null?bill.getBillNo():bill.getBillId()) + ".pdf";
