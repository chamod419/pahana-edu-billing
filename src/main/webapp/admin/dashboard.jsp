...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .icon-customers{ background: rgba(245,158,11,0.10); color: var(--gold); }
        .icon-items{     background: rgba(5,150,105,0.10);  color: var(--emerald); }
        .icon-bills{     background: rgba(37,99,235,0.10);  color: var(--royal); }
        .icon-revenue{   background: rgba(30,58,138,0.10);  color: var(--deep-navy); }
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">Rs. <c:out value="${todayRevenue}"/></div>
            </div>
        </div>
        ...
        <div class="nav-section">
            ...
            <div class="nav-grid">
                <a href="${ctx}/admin/users" class="nav-link">
                ...
                <a href="${ctx}/admin/reports.jsp" class="nav-link">
                    <span class="nav-icon">📊</span>
